...
2. Using class modules allows you to use interfaces and polymorphism which make for easy refactoring, unit testing, etc. The cSqlite3 class now implements the ISqlite3 interface to facilitate these features.
